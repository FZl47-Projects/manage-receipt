...
class CustomBaseUserManager(BaseUserManager):
    ...
    def create_financial_user(self,phonenumber, password,email=None, **extra_fields):
        return self.create_user(phonenumber=phonenumber,password=password,role='financial_user',email=email,**extra_fields)
    ...
    def create_superuser(self,phonenumber, password,email=None, **extra_fields):
        ...
        return self.create_user(phonenumber=phonenumber, password=password,role='super_user',email=email,**extra_fields)
